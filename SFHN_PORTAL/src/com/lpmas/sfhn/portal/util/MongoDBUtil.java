package com.lpmas.sfhn.portal.util;
...
import com.lpmas.sfhn.portal.config.SfhnMongoConfig;
	...
	public static <E> List<E> getRecordListResult(HashMap<String, Object> condMap,
		...
		if (pageBean == null) {
			...
			cursor = collection.find(searchCondition).sort(getOrderByBson(orderBy, asc))
					.skip(pageBean.getPrePageNumber() * pageBean.getPageSize()).limit(pageBean.getPageSize())
					.iterator();
		}
