...
public class DeclareReportHandler {
	...
	public void createDeclareReport(DeclareInfoBean declareInfoBean, int classId, boolean isQuitClass) throws Exception {
		...
		try {
			...
			FarmerJobInfoBean farmerJobInfoBean = FarmerJobInfoBusiness.getFarmerJobInfoByKey(declareInfoBean
					.getDeclareId());
			FarmerSkillInfoBusiness farmerSkillInfoBusiness = new FarmerSkillInfoBusiness();
			FarmerSkillInfoBean farmerSkillInfoBean = farmerSkillInfoBusiness.getFarmerSkillInfoByKey(declareInfoBean
					.getDeclareId());
			...
			if (farmerSkillInfoBean != null) {
				...
				declareReportBean.setHasNewTypeTrainingCertification(farmerSkillInfoBean
						.getHasNewTypeTrainingCertification());
			...
			// 保存库存对象数据到MongoDB
			DeclareReportBean originalBean = declareReportBusiness.getDeclareReportByKey(String.valueOf(declareInfoBean
					.getDeclareId()));
