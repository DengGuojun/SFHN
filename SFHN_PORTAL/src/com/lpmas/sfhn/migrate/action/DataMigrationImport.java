...
@WebServlet("/sfhn/migrate/DataMigrationImport.do")
public class DataMigrationImport extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		RequestDispatcher rd = request.getRequestDispatcher(SfhnPortalConfig.MIGRATE_PAGE_PATH + "DataMigrationImport.jsp");
