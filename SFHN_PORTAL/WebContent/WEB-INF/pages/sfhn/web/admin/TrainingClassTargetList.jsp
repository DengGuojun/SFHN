 ...
 <div class="container">
        <div class="row">
            ...
            <div class="center-side">
                <div class="main-hd">
                    <span class="u-title"><a href="javascript:history.go(-1);"><i class="icon-return"></i></a>培训情况统计表</span>
                ...
                <div class="main-bd">
                    <section class="section-wrp">
                     <ul class="nav nav-tabs nav-justified">
                            <li class="active"><a href="TrainingClassTargetList.do">培训情况统计</a></li>                          
                        ...
                        <table class="table table-odd table-bordered table-center">
							...
							<%} %>
                             ...
                             <tr>
								...
								<td><a href="TrainingClassTargetList.do?queryProvince=<%=key %>"><%=key %></a></td>
								...
								<td><a href="TrainingClassTargetList.do?queryRegion=<%=key %>&queryProvince=<%=declareReportMap.get(key).get(19) %>&queryCity=<%=declareReportMap.get(key).get(20) %>"><%=key %></a></td>
								<td><%=declareReportMap.get(key).get(1) %></td>
								...
								<td><%=key %></td>
								<td><%=declareReportMap.get(key).get(1) %></td>
								<td><a href="TrainingClassUserBaseList.do?organizationId=<%=declareReportMap.get(key).get(19) %>"><%=declareReportMap.get(key).get(2) %></a></td>
								<td><%=declareReportMap.get(key).get(3) %></td>
								<td><%=declareReportMap.get(key).get(4) %></td>
								<td><a href="TrainingClassUserBaseList.do?organizationId=<%=declareReportMap.get(key).get(19) %>&trainingType=<%=DeclareInfoConfig.DECLARE_TYPE_PRODUCT_FARMER %>"><%=declareReportMap.get(key).get(5) %></a></td>
                                <td><%=declareReportMap.get(key).get(6) %></td>
                                <td><%=declareReportMap.get(key).get(7) %></td>
                                <td><a href="TrainingClassUserBaseList.do?organizationId=<%=declareReportMap.get(key).get(19) %>&trainingType=<%=DeclareInfoConfig.DECLARE_TYPE_TECHNICAL_FARMER %>"><%=declareReportMap.get(key).get(8) %></a></td>
                                <td><%=declareReportMap.get(key).get(9) %></td>
                                <td><%=declareReportMap.get(key).get(10) %></td>
                                <td><a href="TrainingClassUserBaseList.do?organizationId=<%=declareReportMap.get(key).get(19) %>&trainingType=<%=DeclareInfoConfig.DECLARE_TYPE_SERVICE_FARMER %>"><%=declareReportMap.get(key).get(11) %></a></td>
                                <td><%=declareReportMap.get(key).get(12) %></td>
                                <td><%=declareReportMap.get(key).get(13) %></td>
                                <td><a href="TrainingClassUserBaseList.do?organizationId=<%=declareReportMap.get(key).get(19) %>&trainingType=<%=DeclareInfoConfig.DECLARE_TYPE_YOUNG_FARMER %>"><%=declareReportMap.get(key).get(14) %></a></td>
                                <td><%=declareReportMap.get(key).get(15) %></td>
                                <td><%=declareReportMap.get(key).get(16) %></td>
                                <td><a href="TrainingClassUserBaseList.do?organizationId=<%=declareReportMap.get(key).get(19) %>&trainingType=<%=DeclareInfoConfig.DECLARE_TYPE_LEADER_FARMER %>"><%=declareReportMap.get(key).get(17) %></a></td>
                                <td><%=declareReportMap.get(key).get(18) %></td>
								<%}%>
							</tr>
							<%} %>
