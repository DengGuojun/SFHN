	...
	<div class="container">
		<div class="container-bd mt0">
			...
			<%for(TrackingInfoBean bean : list){ %>
				<dd class="list-item" onclick="javascript:location.href='TrackingServiceInfoList.do?trackingId=<%=bean.getTrackingId()%>&classId=<%=classId%>'"><span><%=bean.getUserName() %></span></dd>
			<%} %>
			</dl>
		</div>
			<!-- 分页栏 -->
