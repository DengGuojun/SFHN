...
<%
	TrainingCourseInfoBean bean = (TrainingCourseInfoBean)request.getAttribute("TrainingCourseInfo");
  ...
  <div class="container">
        <div class="row">
            ...
            <div class="center-side">
                <div class="main-hd">
                    <span class="u-title"><a href="javascript:history.go(-1);"><i class="icon-return"></i></a><%if(bean.getCourseId() == 0){ %>新增课程信息<%}else{ %>编辑课程信息<%} %></span>
                    ...
                    <form class="form-box col-xs-8" id="formData" method="post"  onsubmit="javascript:return checkForm('formData');">
                        ...
                        <div class="section-wrp form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-xs-10">
                                    <input type="text" class="form-control" name="courseName"  value="<%=bean.getCourseName() %>" checkStr="课程名;txt;true;;100">
                                </div>
                            </div>
                            <div class="form-group">
